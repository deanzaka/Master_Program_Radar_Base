...
; 0002 0015 {
_button:
; 0002 0016      if(a == push_1)
;	a -> Y+0
	LD   R26,Y
	CPI  R26,LOW(0x1)
	BRNE _0x40013
; 0002 0017      {
; 0002 0018           return !PINB.0;
	LDI  R30,0
	SBIS 0x16,0
	LDI  R30,1
	RJMP _0x2000001
; 0002 0019      }
; 0002 001A      if(a == push_2)
_0x40013:
	LD   R26,Y
	CPI  R26,LOW(0x2)
	BRNE _0x40014
; 0002 001B      {
; 0002 001C           return !PINB.1;
	LDI  R30,0
	SBIS 0x16,1
	LDI  R30,1
	RJMP _0x2000001
; 0002 001D      }
; 0002 001E      if(a == push_3)
_0x40014:
	LD   R26,Y
	CPI  R26,LOW(0x3)
	BRNE _0x40015
; 0002 001F      {
; 0002 0020           return !PINB.2;
	LDI  R30,0
	SBIS 0x16,2
	LDI  R30,1
	RJMP _0x2000001
; 0002 0021      }
; 0002 0022      if(a == push_4)
_0x40015:
	LD   R26,Y
	CPI  R26,LOW(0x4)
	BRNE _0x40016
; 0002 0023      {
; 0002 0024           return !PINB.3;
	LDI  R30,0
	SBIS 0x16,3
	LDI  R30,1
; 0002 0025      }
